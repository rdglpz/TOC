...
class TOC:    
    ...
    def generateMassFunction_secant(self, X, Y, h = 10000):
        ...
        """
        X: the TPplusFP for observed thresholds. X = [0, 4, 1000]. Not regular intervals.

        Y: The TP associated with the thresholds Y = [0, 20, 800]

        we want to fill the gaps to produce a toc filled in regular intervals
